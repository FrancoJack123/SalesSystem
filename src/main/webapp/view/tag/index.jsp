                            ...
                            <tr>
                                ...
                                <td class="col-1">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <a class="btn btn-nawijo" href="<c:url value='/tag?id=${item.id}' />">
                                            <i class="fas fa-pen text-secondary"></i>
                                        </a>
                                        <form action="<c:url value="/tag"/>" method="post" onsubmit="return confirm('Estas seguro de eliminar')">
