        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="<c:url value='/tag' />">Tags</a></li>
                    <li class="breadcrumb-item active"><c:out value="${item.id}"/></li>
                </ol>
                <div>
                    <form action="<c:url value="/tag"/>" method="post">
                        ...
                        <button type="submit" class="btn btn-nawijo">Submit</button> | <a href="<c:url value='/tag' />" class="btn btn-nawijo">Regresar</a>
                    </form>
                </div>
            </div>
        </main>
