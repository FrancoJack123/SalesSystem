            ...
            <div class="container-fluid px-4">
                ...
                <div class="row mb-1">
                    <div class="col-sm-12 col-md-6 text-center text-md-start">
                        <a class="btn btn-nawijo" href="<c:url value='/cliente?id=0' />">Agregar</a>
                            ...
                            <tr>
                                ...
                                <td class="col-1">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <a class="btn btn-nawijo" href="<c:url value='/cliente?id=${item.id}' />">
                                            <i class="fas fa-pen text-secondary"></i>
                                        </a>
                                        <form action="<c:url value="/cliente"/>" method="post" onsubmit="return confirm('Estas seguro de eliminar')">
