                    ...
                    <table class="table table-bordered align-middle" id="datatablesSimple">
                        ...
                        <c:forEach items="${items}" var="item">
                            <tr>
                                ...
                                <td><c:out value="${item.category.nombre}"/></td>
                                <td>
                                    <c:forEach items="${item.tags}" var="tag">
                                        <span class="badge text-bg-secondary"><c:out value="${tag.nombre}"/></span>
                                    </c:forEach>
                                </td>
                                ...
                                <td class="col-1">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <a class="btn btn-nawijo" href="<c:url value='/producto?id=${item.id}' />">
                                            <i class="fas fa-pen text-secondary"></i>
                                        </a>
                                        <form action="<c:url value="/producto"/>" method="post" onsubmit="return confirm('Estas seguro de eliminar')">
